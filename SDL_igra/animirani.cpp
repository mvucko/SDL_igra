...
void AnimatedSprite::draw(Graphics &graphics, int x, int y) {
	...
	if (this->_visible) {
		...
		SDL_Rect sourceRect = this->_animations[this->_currentAnimation][this->_frameIndex];  //prvi indeks je vektor koji uzima animaciju, drugi je sto uzima tocan vektor u rect
